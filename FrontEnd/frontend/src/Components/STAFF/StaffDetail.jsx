...
const token = 'eyJhbGciOiJIUzI1NiJ9..LePchv_ZVqs2CDqVRF-532zt1AokRbjWxtM6xi4OfXo';
...
const StaffDetail = () => {
  ...
  const url = `https://bookstorewebdeploy-production.up.railway.app/BookStore/admin/user/delete/${staffId}`;
...
function EditStaffInfor({ staffId }) {
  ...
  const url = `https://bookstorewebdeploy-production.up.railway.app/BookStore/staff/update/info/${staffId}`;
      ...
      <div className='p-4 w-5/6 flex flex-col gap-10'>
        <div className="setting-content flex flex-row w-full h-2/4">
          <div className='w-1/3 h-2/5 mt-3'>
            ...
            />
            <button onClick={handleFileButtonClick} className="border-2 ml-12 mt-5 m-2 text-header--lightcolor font-semibold py-2 px-4 rounded-full">Sửa ảnh</button>
          </div>
          <div className="content-staffinf flex-1 h-2/5 flex flex-col ml-2 w-4 ">
            <div className="m-2 flex gap-1 text-primary--color">
              ...
              <input type="text" className="m-2" value={"NV" + staff.id} readOnly />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
              <span className="text-header--lightcolor flex items-center">Họ và tên: </span>
              <input type="text" className="m-2" value={staff_fullname} onChange={(e) => setStaffFullname(e.target.value)} />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
              <span className="text-header--lightcolor flex items-center">Email: </span>
              <input type="text" className="m-2" value={staff_email} onChange={(e) => setStaffEmail(e.target.value)} />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
              <span className="text-header--lightcolor flex items-center">Giới tính: </span>
              <select className="m-2" value={staff_gender ? 'true' : 'false'} onChange={(e) => setStaffGender(e.target.value === 'true')}>
            ...
            <div className="m-2 flex gap-1 text-primary--color">
              ...
              <input type="text" className="m-2" value={staff_birthday} onChange={(e) => setStaffBirthday(e.target.value)} />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
              <span className="text-header--lightcolor flex items-center">Số điện thoại: </span>
              <input type="text" className="m-2" value={staff_phonenumber} onChange={(e) => setStaffPhoneNumber(e.target.value)} />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
        ...
        <div className="z-10 w-full mt-2 max-md:max-w-full h-2/5">
          ...
          <div className="content-jobinfor ml-9 flex-1 w-full flex-col pt-2">
            ...
            <div className="m-2 flex gap-1 text-primary--color">
              ...
              <input type="text" className="m-2 -mt-0" value={staff_initiate_time} onChange={(e) => setStaffInitiateTime(e.target.value)} />
            </div>
            <div className="m-2 flex gap-1 text-primary--color">
              <span className="text-header--lightcolor flex items-center">Lương: </span>
              <input type="text" className="m-2" value={staff_salary} onChange={(e) => setStaffSalary(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
      <button className="bg-primary--color m-2 text-[#fff] font-bold py-2 px-4 rounded" onClick={handleEditStaff}>
        Chỉnh sửa
      </button>
    </div>
  );
