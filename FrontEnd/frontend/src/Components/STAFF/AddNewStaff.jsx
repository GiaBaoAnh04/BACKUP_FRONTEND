...
export default function AddNewStaff() {
    ...
    const url = `https://bookstorewebdeploy-production.up.railway.app/BookStore/staff/create/info/${id}`;
    const REGISTER_URL = `https://bookstorewebdeploy-production.up.railway.app/BookStore/staff/register`;
    ...
    return (
        <div className="w-full h-full flex flex-col gap-8">
            <div className="mt-2 ml-3 text-base text-primary--color gap-4 p-3 border-b">Chỉnh sửa thông tin nhân viên</div>
